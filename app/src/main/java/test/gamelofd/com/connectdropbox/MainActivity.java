package test.gamelofd.com.connectdropbox;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private final static String ACCESS_KEY = "pxo5gwrfu5rgmn0";
    private final static String ACCESS_SECRET = "wkot6f2thnryk28";
